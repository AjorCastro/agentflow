...
### Bootstrap the pending coordination folder
...
### Draft POLICY.md's stable questions
...
### Validate the plan from an implementer's perspective
...
### Promote the pending coordination folder
...
### Fill in POLICY.md's branch/worktree/root fields
...
### Seed the first task from PLAN.md
...
### Tell the Human to link the Coder
